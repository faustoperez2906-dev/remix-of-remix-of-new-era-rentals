...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "New Era Party & Event Rentals | Luxury Party Rentals in Los Angeles" },
      { name: "description", content: "Luxury party & event rentals in East Los Angeles. Chairs, tables, linens, tents, lighting & more. Call (323) 480-0660 for a free quote." },
      { name: "author", content: "New Era Party & Event Rentals" },
      { property: "og:title", content: "New Era Party & Event Rentals" },
      { property: "og:description", content: "Luxury party & event rentals in East Los Angeles. Free quotes." },
